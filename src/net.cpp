...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eponacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"77.103.234.52", "77.103.234.52"},
    {"45.55.89.248", "45.55.89.248"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eponacoin is probably already running."), addrBind.ToString().c_str());
        else
